...
def test():
    ...
    save_some_examples_plots(generator, test_loader, epoch="test", folder=os.path.join(args.save_dir, f"test_results_{args.random_state}"), device=device, denorm=False, num_samples=args.save_n)
    save_some_examples(generator, test_loader, epoch="test", folder=os.path.join(args.save_dir, f"test_results_{args.random_state}_saveimg"), device=device, denorm=False, num_samples=args.save_n)
